...
<section id="job-listings" class="section bg-cyan">
        ...
        <h2 class="section-title">Latest Job Post</h2>
        ...
        <img src="{{ asset('template/img/features/img1.png') }}" alt="">
        </div>
        ...
        <div class="col-lg-4 col-md-4 col-xs-12">
        <div class="job-company-logo">
        <img src="{{ asset('template/img/features/img2.png') }}" alt="">
        </div>
        <div class="job-details">
        <h3>App Developer</h3>
        <span class="company-neme">
        ...
        <div class="col-lg-4 col-md-4 col-xs-12">
        <div class="job-company-logo">
        <img src="{{ asset('template/img/features/img3.png') }}" alt="">
        </div>
        <div class="job-details">
        <h3>App Developer</h3>
        <span class="company-neme">
        ...
        <div class="col-lg-4 col-md-4 col-xs-12">
        <div class="job-company-logo">
        <img src="{{ asset('template/img/features/img4.png') }}" alt="">
         </div>
        <div class="job-details">
        <h3>App Developer</h3>
        <span class="company-neme">
