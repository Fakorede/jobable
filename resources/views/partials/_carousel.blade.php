<div id="carousel-area">
        ...
        <img src="{{ asset('template/img/slider/bg-1.jpg') }}" alt="">
        ...
        <img src="{{ asset('template/img/slider/img-1.png') }}" alt="">
        </div>
        </div>
        </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-4 col-xs-12">
        <div class="img-wrapper wow fadeInUp" data-wow-delay="0.6s">
        <img src="{{ asset('template/img/slider/img-2.png') }}" alt="">
        </div>
        </div>
        </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-4 col-xs-12">
        <div class="img-wrapper wow fadeInUp" data-wow-delay="0.6s">
        <img src="{{ asset('template/img/slider/img-3.png') }}" alt="">
        </div>
        </div>
        </div>
        </div>
